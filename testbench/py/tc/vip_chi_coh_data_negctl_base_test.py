################################################################################
# pyUVM port of tc/vip_chi_coh_data_negctl_base_test.sv.
#
...
class vip_chi_coh_data_negctl_base_test(vip_chi_coherent_base_test):
  ...
  async def run_phase(self):
    ...
    catcher = vip_chi_coherency_negctl_catcher("coh_data_violation_catcher")
