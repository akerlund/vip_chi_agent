...
################################################################################
#
# pyUVM port of tc/chi_base_test.sv (integrated RN-I <-> SN-F cut).
#
...
from chi_tb_env import chi_tb_env
...
class chi_base_test(uvm_test):
  ...
  def build_phase(self):
    ...
    self.tb_env = chi_tb_env("tb_env", self)
