...
################################################################################
#
# pyUVM port of tc/vip_chi_coherent_base_test.sv -- base test for the isolated
...
from vip_chi_coherent_tb_env import vip_chi_coherent_tb_env
...
class vip_chi_coherent_base_test(uvm_test):
  ...
  def build_phase(self):
    ...
    self.tb_env = vip_chi_coherent_tb_env("tb_env", self)
