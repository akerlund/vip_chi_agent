...
################################################################################
#
# pyUVM/cocotb port of tc/tc_chi_e_combined_write_pgroup.sv.
#
...
class tc_chi_e_combined_write_pgroup(chi_e_base_test):
  ...
  async def run_phase(self):
    ...
    seq = vip_chi_write_cmo_seq("write_cmo_pgroup", cfg=self.chi_cfg)
    ...
    self.logger.info(
      f"Test (tc_chi_e_combined_write_pgroup) PASS: a combined Write + PCMO's Persist "
