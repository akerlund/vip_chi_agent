...
@cocotb.test(name="tc_chi_coh_d_read_clean_snoop", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_d_read_clean_snoop(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_read_clean_snoop"
  await _run_d_coherent(dut, test_name)
...
async def tc_chi_coh_d_snoop_match_negctl(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_snoop_match_negctl"
  await _run_d_coherent(dut, test_name)
...
@cocotb.test(name="tc_chi_coh_d_comp_resp_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_d_comp_resp_negctl(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_comp_resp_negctl"
  await _run_d_coherent(dut, test_name)


@cocotb.test(name="tc_chi_coh_d_fwd_target_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_d_fwd_target_negctl(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_fwd_target_negctl"
  await _run_d_coherent(dut, test_name)
...
@cocotb.test(name="tc_chi_coh_d_lasm_deactivate", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_d_lasm_deactivate(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_lasm_deactivate"
  await _run_d_coherent(dut, test_name)


@cocotb.test(name="tc_chi_coh_d_hnf_sn_txsactive", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_d_hnf_sn_txsactive(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_hnf_sn_txsactive"
  await _run_d_coherent(dut, test_name)
...
@cocotb.test(name="tc_chi_coh_d_txsactive_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_d_txsactive_negctl(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_txsactive_negctl"
  await _run_d_coherent(dut, test_name)


@cocotb.test(name="tc_chi_coh_d_snp_txsactive_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_d_snp_txsactive_negctl(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_snp_txsactive_negctl"
  await _run_d_coherent(dut, test_name)
...
async def tc_chi_coh_d_txsactive_window(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_txsactive_window"
  await _run_d_coherent(dut, test_name)
...
@cocotb.test(name="tc_chi_coh_e_snp_field_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_e_snp_field_negctl(dut) -> None:
  """Run this public testcase through the CHI-E coherent topology."""
  test_name = "tc_chi_coh_e_snp_field_negctl"
  await _run_e_coherent(dut, test_name)
...
@cocotb.test(name="tc_chi_coh_e_read_clean_snoop", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_e_read_clean_snoop(dut) -> None:
  """Run this public testcase through the CHI-E coherent topology."""
  test_name = "tc_chi_coh_e_read_clean_snoop"
  await _run_e_coherent(dut, test_name)
...
@cocotb.test(name="tc_chi_coh_e_comp_resp_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_e_comp_resp_negctl(dut) -> None:
  """Run this public testcase through the CHI-E coherent topology."""
  test_name = "tc_chi_coh_e_comp_resp_negctl"
  await _run_e_coherent(dut, test_name)


@cocotb.test(name="tc_chi_coh_e_fwd_target_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_e_fwd_target_negctl(dut) -> None:
  """Run this public testcase through the CHI-E coherent topology."""
  test_name = "tc_chi_coh_e_fwd_target_negctl"
  await _run_e_coherent(dut, test_name)
...
@cocotb.test(name="tc_chi_coh_e_lasm_deactivate", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_e_lasm_deactivate(dut) -> None:
  """Run this public testcase through the CHI-E coherent topology."""
  test_name = "tc_chi_coh_e_lasm_deactivate"
  await _run_e_coherent(dut, test_name)
...
async def tc_chi_coh_e_hnf_sn_txsactive(dut) -> None:
  """Run this public testcase through the CHI-E coherent topology."""
  test_name = "tc_chi_coh_e_hnf_sn_txsactive"
  await _run_e_coherent(dut, test_name)
...
@cocotb.test(name="tc_chi_coh_e_txsactive_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_e_txsactive_negctl(dut) -> None:
  """Run this public testcase through the CHI-E coherent topology."""
  test_name = "tc_chi_coh_e_txsactive_negctl"
  await _run_e_coherent(dut, test_name)


@cocotb.test(name="tc_chi_coh_e_snp_txsactive_negctl", timeout_time=20, timeout_unit="ms")
...
@cocotb.test(name="tc_chi_coh_d_snp_link_gate_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_d_snp_link_gate_negctl(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_snp_link_gate_negctl"
  await _run_d_coherent(dut, test_name)


@cocotb.test(name="tc_chi_coh_e_snp_link_gate_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_e_snp_link_gate_negctl(dut) -> None:
  """Run this public testcase through the CHI-E coherent topology."""
  test_name = "tc_chi_coh_e_snp_link_gate_negctl"
  await _run_e_coherent(dut, test_name)


@cocotb.test(name="tc_chi_coh_d_partial_dirty_merge", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_d_partial_dirty_merge(dut) -> None:
  """Run this public testcase through the CHI-D coherent topology."""
  test_name = "tc_chi_coh_d_partial_dirty_merge"
  await _run_d_coherent(dut, test_name)


@cocotb.test(name="tc_chi_coh_e_partial_dirty_merge", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_e_partial_dirty_merge(dut) -> None:
  """Run this public testcase through the CHI-E coherent topology."""
  test_name = "tc_chi_coh_e_partial_dirty_merge"
  await _run_e_coherent(dut, test_name)
...
@cocotb.test(name="tc_chi_coh_e_txsactive_window", timeout_time=20, timeout_unit="ms")
async def tc_chi_coh_e_txsactive_window(dut) -> None:
  """Run this public testcase through the CHI-E coherent topology."""
  test_name = "tc_chi_coh_e_txsactive_window"
  await _run_e_coherent(dut, test_name)
...
@cocotb.test(name="tc_chi_d_lcrd_overgrant", timeout_time=20, timeout_unit="ms")
async def tc_chi_d_lcrd_overgrant(dut) -> None:
  """Run this public testcase through the CHI-D link topology."""
  test_name = "tc_chi_d_lcrd_overgrant"
  await _run_d_link(dut, test_name)

@cocotb.test(name="tc_chi_d_lcrd_grant_cycle_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_d_lcrd_grant_cycle_negctl(dut) -> None:
  """Run this public testcase through the CHI-D link topology."""
  test_name = "tc_chi_d_lcrd_grant_cycle_negctl"
  await _run_d_link(dut, test_name)
...
@cocotb.test(name="tc_chi_pcrd_return", timeout_time=20, timeout_unit="ms")
async def tc_chi_pcrd_return(dut) -> None:
  """Run this public testcase through the CHI-D link topology."""
  test_name = "tc_chi_pcrd_return"
  await _run_d_link(dut, test_name)
...
async def tc_chi_lasm_illegal_transition(dut) -> None:
  """Run this public testcase through the CHI-D link topology."""
  test_name = "tc_chi_lasm_illegal_transition"
  await _run_d_link(dut, test_name)
...
async def tc_chi_lasm_input_race_negctl(dut) -> None:
  """Run this public testcase through the CHI-D link topology."""
  test_name = "tc_chi_lasm_input_race_negctl"
  await _run_d_link(dut, test_name)


@cocotb.test(name="tc_chi_lasm_output_race_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_lasm_output_race_negctl(dut) -> None:
  """Run this public testcase through the CHI-D link topology."""
  test_name = "tc_chi_lasm_output_race_negctl"
  await _run_d_link(dut, test_name)


@cocotb.test(name="tc_chi_flitpend_without_valid", timeout_time=20, timeout_unit="ms")
async def tc_chi_flitpend_without_valid(dut) -> None:
  """Run this public testcase through the CHI-D link topology."""
  test_name = "tc_chi_flitpend_without_valid"
  await _run_d_link(dut, test_name)


@cocotb.test(name="tc_chi_flit_without_flitpend", timeout_time=20, timeout_unit="ms")
async def tc_chi_flit_without_flitpend(dut) -> None:
  """Run this public testcase through the CHI-D link topology."""
  test_name = "tc_chi_flit_without_flitpend"
  await _run_d_link(dut, test_name)
...
async def tc_chi_ordered_write_no_comp_ack(dut) -> None:
  """Run this public testcase through the CHI-D link topology."""
  test_name = "tc_chi_ordered_write_no_comp_ack"
  await _run_d_link(dut, test_name)
...
async def tc_chi_e_write_cmo(dut) -> None:
  ...
  test_name = "tc_chi_e_write_cmo"
  await _run_e_link(dut, test_name)


@cocotb.test(name="tc_chi_e_tag_integrity", timeout_time=20, timeout_unit="ms")
async def tc_chi_e_tag_integrity(dut) -> None:
  """Run this public testcase through the CHI-E topology."""
  test_name = "tc_chi_e_tag_integrity"
  await _run_e_link(dut, test_name)


@cocotb.test(name="tc_chi_e_tag_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_e_tag_negctl(dut) -> None:
  """Run this public testcase through the CHI-E topology."""
  test_name = "tc_chi_e_tag_negctl"
  await _run_e_link(dut, test_name)
...
@cocotb.test(name="tc_chi_e_raw_txsactive_negctl", timeout_time=20, timeout_unit="ms")
async def tc_chi_e_raw_txsactive_negctl(dut) -> None:
  """Run this public testcase through the CHI-E link topology."""
  test_name = "tc_chi_e_raw_txsactive_negctl"
  await _run_e_link(dut, test_name)
...
async def tc_chi_txnid_reuse_srcid_scope(dut) -> None:
  """Run this public testcase through the CHI-E link topology."""
  test_name = "tc_chi_txnid_reuse_srcid_scope"
  await _run_e_link(dut, test_name)
