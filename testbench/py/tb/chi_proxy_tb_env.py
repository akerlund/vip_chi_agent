...
################################################################################
#
# pyUVM port of the HN-I proxy env (Wave 6), sized to the SV chi_tb_env
...
class chi_proxy_tb_env(uvm_env):
  ...
  def connect_phase(self):
    ...
    # Standalone scoreboard (mirrors the proxy wiring in SV chi_tb_env):
