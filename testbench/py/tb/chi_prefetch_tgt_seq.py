...
################################################################################
#
# pyUVM port of tb/chi_prefetch_tgt_seq.sv -- forces READ direction and a
...
class chi_prefetch_tgt_seq(vip_chi_base_seq):

  def __init__(self, name: str = "chi_prefetch_tgt_seq", cfg: ChiCfg = None):
