...
#
# The HDL counterpart is tb/vip_chi_hdl_top.sv. That file is only a flat-net
...
for path in _PATHS:
  if path.is_dir() and str(path) not in sys.path:
    ...
    raise RuntimeError(f"vip_chi_tb_top: expected source dir not found: {path}")


from vip_chi_if import CHANNELS, ChiBus
from vip_chi_types_pkg import ChiCfg, Issue, ReqOpcode, Role, pack, unpack
from vip_chi_tb_pkg import CHI_D_CFG, CHI_E_WIDE_CFG
