...
################################################################################
#
# pyUVM port of tb/vip_chi_tb_env.sv (integrated RN-I <-> SN-F pair cut).
#
...
class vip_chi_tb_env(uvm_env):
  ...
  def connect_phase(self):
    ...
    # Functional coverage: RN-I + SN-F req/rsp/dat streams (mirrors SV vip_chi_tb_env).
