// ===========================================================================
// vip_chi_e_proxy_tb_env
//
// Wide CHI-E HN-I proxy environment: the CHI-D proxy topology (vip_chi_tb_env)
...
// widen.
//
// Standalone, like vip_chi_e_tb_env: no virtual sequencer (the CHI-E leaf
// sequencers are #(CHI_E_WIDE_CFG_C); the CHI-D vip_chi_virtual_sequencer holds
// #(CHI_D_CFG_C) handles). Tests start sequences directly on
// hrni{0,1}_agent.sequencer.
// ===========================================================================
class vip_chi_e_proxy_tb_env extends uvm_env;
  ...
  `uvm_component_utils(vip_chi_e_proxy_tb_env)
