...
// directory. Mirrors the standalone shape of vip_chi_e_proxy_tb_env.
//
...
//
// Standalone, like vip_chi_e_tb_env: no virtual sequencer. Tests start
// sequences directly on hrnf{0,1}_agent.sequencer.
// ===========================================================================
class vip_chi_coherent_tb_env #(
  ...
  `uvm_component_param_utils(vip_chi_coherent_tb_env #(CFG_P, TYPES_P))
