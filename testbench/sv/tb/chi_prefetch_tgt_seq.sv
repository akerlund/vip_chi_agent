class chi_prefetch_tgt_seq extends vip_chi_base_seq #(CHI_D_CFG_C);

  `uvm_object_utils(chi_prefetch_tgt_seq)
  ...
  // Constructor
  // ---------------------------------------------------------------------------
  function new(input string name = "chi_prefetch_tgt_seq");
