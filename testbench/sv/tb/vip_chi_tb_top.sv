module vip_chi_tb_top;
  ...
  // Wide CHI-E datapath: real RN-I + SN-F agent pair (vip_chi_e_tb_env).
  ...
  // Wide CHI-E HN-I proxy topology (vip_chi_e_proxy_tb_env): 2 RN-facing
...
`endif
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      if (tb_cfg == null) begin
        void'(uvm_config_db #(vip_chi_tb_config)::get(null, "*", "tb_cfg", tb_cfg));
      end
  ...
  vip_chi_link_adapter int_link     (.rn(rni_if),      .sn(snf_if));
  vip_chi_link_adapter hni_rn0_link (.rn(hni_rni0_if), .sn(hni_rn0_if));
  vip_chi_link_adapter hni_rn1_link (.rn(hni_rni1_if), .sn(hni_rn1_if));
  vip_chi_link_adapter hni_sn0_link (.rn(hni_sn0_if),  .sn(hni_snf0_if));
  vip_chi_link_adapter hni_sn1_link (.rn(hni_sn1_if),  .sn(hni_snf1_if));
  vip_chi_link_adapter e_wide_link  (.rn(chi_e_wide_rni_if), .sn(chi_e_wide_snf_if));
  ...
  vip_chi_link_adapter e_hni_rn0_link (.rn(e_hni_rni0_if), .sn(e_hni_rn0_if));
  vip_chi_link_adapter e_hni_rn1_link (.rn(e_hni_rni1_if), .sn(e_hni_rn1_if));
  vip_chi_link_adapter e_hni_sn0_link (.rn(e_hni_sn0_if),  .sn(e_hni_snf0_if));
  vip_chi_link_adapter e_hni_sn1_link (.rn(e_hni_sn1_if),  .sn(e_hni_snf1_if));
  ...
  vip_chi_link_adapter coh_link0 (.rn(coh_rnf0_if), .sn(coh_hnf0_if));
  vip_chi_link_adapter coh_link1 (.rn(coh_rnf1_if), .sn(coh_hnf1_if));
  // Downstream HN-F <-> SN-F link (HN-F is the requester side).
  vip_chi_link_adapter coh_dsn_link (.rn(coh_hnf0_sn_if), .sn(coh_dsnf0_if));

  // CHI-E coherent links.
  vip_chi_link_adapter coh_e_link0 (.rn(coh_e_rnf0_if), .sn(coh_e_hnf0_if));
  vip_chi_link_adapter coh_e_link1 (.rn(coh_e_rnf1_if), .sn(coh_e_hnf1_if));
  // Downstream HN-F <-> SN-F link (CHI-E parity).
  vip_chi_link_adapter coh_e_dsn_link (.rn(coh_e_hnf0_sn_if), .sn(coh_e_dsnf0_if));
  ...
  initial begin
    ...
    // Isolated coherent env (vip_chi_coherent_tb_env): two RN-F requesters on
    ...
    // CHI-E coherent env (vip_chi_coherent_e_base_test): same agent instance
    ...
    // Wide CHI-E datapath agents (vip_chi_e_tb_env).
    uvm_config_db #(virtual vip_chi_if #(CHI_E_WIDE_CFG_C, chi_e_wide_types_t, VIP_CHI_ROLE_RNI_E))::set(
    ...
    // Wide CHI-E HN-I proxy agents (vip_chi_e_proxy_tb_env). Same env agent
