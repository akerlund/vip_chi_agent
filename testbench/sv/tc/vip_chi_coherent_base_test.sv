// ===========================================================================
// vip_chi_coherent_base_test
//
// Base test for the isolated coherent topology (vip_chi_coherent_tb_env): two
...
// widths. Mirrors vip_chi_e_proxy_base_test's standalone scaffolding (no virtual
...
// its own runnable tests) and vip_chi_coherent_e_base_test (the CHI-E-only
// scenarios' base).
// ===========================================================================
class vip_chi_coherent_base_test #(
  vip_chi_cfg_t CFG_P   = CHI_D_CFG_C,
  type          TYPES_T = chi_d_types_t
) extends uvm_test;

  `uvm_component_param_utils(vip_chi_coherent_base_test #(CFG_P, TYPES_T))
  ...
  vip_chi_coherent_tb_env #(CFG_P, TYPES_T) tb_env;
  ...
  function void build_phase(input uvm_phase phase);
    ...
    this.tb_env = vip_chi_coherent_tb_env #(CFG_P, TYPES_T)::type_id::create("env", this);
  endfunction
