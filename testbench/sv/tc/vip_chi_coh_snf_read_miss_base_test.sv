// ===========================================================================
// vip_chi_coh_snf_read_miss_base_test
//
...
// ===========================================================================
class vip_chi_coh_snf_read_miss_base_test #(
  ...
  `uvm_component_param_utils(vip_chi_coh_snf_read_miss_base_test #(CFG_P, TYPES_T))
