// ===========================================================================
// chi_e_proxy_base_test
//
// Base test for the wide CHI-E HN-I proxy topology (chi_e_proxy_tb_env).
// Mirrors chi_base_test's proxy scaffolding, but at CHI_E_WIDE_CFG_C and
...
// ===========================================================================
class chi_e_proxy_base_test extends uvm_test;

  `uvm_component_utils(chi_e_proxy_base_test)
  ...
  function void build_phase(input uvm_phase phase);
    ...
    this.tb_env = chi_e_proxy_tb_env::type_id::create("env", this);
  endfunction
