// ===========================================================================
// chi_coh_read_after_writeback_base_test
//
...
// ===========================================================================
class chi_coh_read_after_writeback_base_test #(
  ...
  `uvm_component_param_utils(chi_coh_read_after_writeback_base_test #(CFG_P, TYPES_T))
