// ===========================================================================
// vip_chi_coherent_e_base_test
//
// Wide-CHI-E specialization of the parameterized vip_chi_coherent_base_test:
...
// ===========================================================================
class vip_chi_coherent_e_base_test extends vip_chi_coherent_base_test #(CHI_E_WIDE_CFG_C, chi_e_wide_types_t);

  `uvm_component_utils(vip_chi_coherent_e_base_test)
