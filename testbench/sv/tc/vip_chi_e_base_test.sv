class vip_chi_e_base_test extends uvm_test;

  `uvm_component_utils(vip_chi_e_base_test)
  ...
  function void build_phase(input uvm_phase phase);
    ...
    this.tb_env = vip_chi_e_tb_env::type_id::create("env", this);
  endfunction
